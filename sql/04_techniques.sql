...
('swift_steps', 'Стремительные шаги', 'Техника повышения скорости движений', '⚡', 0, NULL, 15, 4, 5, 'support', 2),
...
-- Эффекты для Стремительных шагов
('swift_steps', 'speed', 'Ускорение', 20, NULL, NULL),
...
-- Статистики для эффекта Ускорение (Стремительные шаги)
(10, 'evasion', 20),
(10, 'accuracy', 10);
