...
(4, 'protective_talisman', 'artifact', 'Защитный талисман', 'Талисман с защитными заклинаниями. Создает барьер, защищающий от физических и духовных атак.', 1200, 2, 2, 0.3, NOW(), NULL, 'rare');
